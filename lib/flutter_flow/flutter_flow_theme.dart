...
class LightModeTheme extends FlutterFlowTheme {
  late Color primaryColor = const Color(0xFFE99607);
  late Color secondaryColor = const Color(0xFFF4A261);
  late Color tertiaryColor = const Color(0xFFE76F51);
  ...
  late Color charcoal = Color(0xFF264653);
  late Color persianGreen = Color(0xFF2A9D8F);
  late Color maizeCrayola = Color(0xFFE9C46A);
  late Color sandyBrown = Color(0xFFF4A261);
  late Color burntSienna = Color(0xFFE76F51);
