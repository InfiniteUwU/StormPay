    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'userTitle':
          ...
          break;
        case 'userMoney':
          result.userMoney = serializers.deserialize(value,
...
class UsersRecordBuilder implements Builder<UsersRecord, UsersRecordBuilder> {
  ...
  double? _userMoney;
  double? get userMoney => _$this._userMoney;
  set userMoney(double? userMoney) => _$this._userMoney = userMoney;
